...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("QWidget{background-color: #232628;}")
        ...
        self.view.load(QtCore.QUrl("http://papi7000.pythonanywhere.com/"))
    ...
    def refresh(self):
        ...
        self.view.load(QtCore.QUrl(f"http://papi7000.pythonanywhere.com/days={days}&currencies=USD,CAD"))
